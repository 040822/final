...
class MBartTrainer:
    ...
    def __init__(self, model_name="facebook/mbart-large-cc25", max_length=512):
...
def train_mbart_model(datasets, model_name="facebook/mbart-large-cc25", size=0.1, use_cache=True):
    """训练mBART模型"""
    print("\n" + "="*50)
    print("训练mBART模型")
    print("="*50)
